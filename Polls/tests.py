...
class QuestionModelTests(TestCase):
    def test_was_published_recently_with_future_question(self):
        """
        return false for a question whose pub_date is in future
        """
...
class QuestionIndexViewTests(TestCase):
    ...
    def test_two_future_question(self):
        ...
        create_question(question_text = 'Future question 2.', days = 2)
        response = self.client.get(reverse("polls:index"))
        self.assertQuerysetEqual(response.context["question_list"],[])
...
class QuestionDetailViewTests(TestCase):
    ...
    def test_past_question(self):
        ...
        #self.assertQuerysetEqual(response.context["question"],['<Past Question.>'])
